...
{
    public sealed class SQLiteDataService : Services.IDataService
    {
        // for SQlite this will be different files for different homes (don't forget to enable WAL)
        private readonly string _connect;
        private readonly ILogger<SQLiteDataService> _log;

        public SQLiteDataService(IConfiguration configuration, ILogger<SQLiteDataService> dataLogger) //IResourceMapper resourceMapper, 
        {
